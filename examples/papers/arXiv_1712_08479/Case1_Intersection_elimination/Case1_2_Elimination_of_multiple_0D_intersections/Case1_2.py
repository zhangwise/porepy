...
benchmark3 with the fv discretizations. It is also to be found as test_fv in
examples/example1/benchmark3
"""
import numpy as np
...
class DarcyModelData(EllipticDataAssigner):
    ...
    def bc(self):
        ...
        dirfaces, labels, _ = boundary_condition(
            self.grid(), self.left_to_right
        )
...
if __name__ == "__main__":
    main(multi_point=False, if_export=True, left_to_right=True)
    main(multi_point=True, if_export=True, left_to_right=True)
