...
class ParabolicModel:
    ...
    def __init__(
        self, gb, physics="transport", time_step=1.0, end_time=1.0, **kwargs
    ):
        self._gb = gb
    ...
    def advective_disc(self):
        ...
        class WeightedUpwindCoupler(upwind.UpwindCoupling):
            ...
            def matrix_rhs(self, g_h, g_l, data_h, data_l, data_edge):
                cc = upwind.UpwindCoupling.matrix_rhs(
                    self, g_h, g_l, data_h, data_l, data_edge
                )
                factor = (
                    data_h["param"].fluid_specific_heat
